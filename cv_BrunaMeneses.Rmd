...
<!-- ![Bruna Arbo Meneses](photo/DSC05985_1.jpg){width=80%} -->
![Bruna Arbo Meneses](photo/54090052819_578ea40009_k_1.jpg){width=80%}
...
Peer-reviewed articles {data-icon=file}
--------------------------------------------------------------------------------
...
Presentations and Posters {data-icon=chalkboard-teacher}
--------------------------------------------------------------------------------
...
Participation in events {data-icon=calendar-o}
--------------------------------------------------------------------------------

```{r}

events %>% 
  print_section_events_part('participation')

```


Professional development {data-icon=pencil}
--------------------------------------------------------------------------------
...
Teaching experience as a instructor {data-icon=chalkboard-teacher}
--------------------------------------------------------------------------------

### Spatial Prioritization for Elaboration of Strategic Areas of Action Plans

worked as a teacher and in the organization of teaching material. 17h.

Online.

2023

National Center for Research and Conservation of Reptiles and Amphibians (RAN/ICMBio).

Teaching experience as a monitor {data-icon=chalkboard-teacher}
--------------------------------------------------------------------------------
...
Worked as a monitor in the discipline offered in the Graduate Program in Ecology at UFRGS, taught by prof. Milton Cezar Ribeiro, from December 10 to 14, 2012. 30h.
